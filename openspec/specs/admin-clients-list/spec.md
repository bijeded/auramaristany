...
The admin client-list view (`/admin/clients`) — its filter pills (subscription status + activity), the per-client last-activity signal, and how client inactivity is defined and computed.
