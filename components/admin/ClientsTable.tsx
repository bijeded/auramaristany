                ...
                {items.map((c) => {
                  ...
                  return (
                    <tr key={c.profile_id} style={{ borderTop: "1px solid var(--gris-linea)", cursor: "pointer" }}
                      ...
                      <td style={{ padding: "12px 20px" }}>
                        <span className="font-body" style={{ display: "inline-block", fontSize: 11.5, fontWeight: 600, padding: "3px 9px", borderRadius: 999, ...BADGE_TONE.lavender, whiteSpace: "nowrap" }}>{c.program_name}</span>
